...
export const MoveToFolderDialog = ({
  ...
  const { mutateAsync: moveDocumentToFolder } = trpc.folder.moveFileToFolder.useMutation();
  ...
  return (
    <Dialog {...props} open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>
            <Trans>Move File to Folder</Trans>
          </DialogTitle>

          <DialogDescription>
            <Trans>Select a folder to move this file to.</Trans>
          </DialogDescription>
        </DialogHeader>
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="mt-4 flex flex-col gap-y-4">
            ...
            <DialogFooter>
              ...
              <Button
                type="submit"
                loading={isFoldersLoading || form.formState.isSubmitting}
                disabled={
